...
GEN_COM = "COM3"                 #GEN power supply using RS
GEN_BAUD = 9600                  #GEN baud rate
...
DFLT_DELAY = "0.001"
DFLT_PROTOCOL = "TCP"               #TCP, UDP, VISA for GEN PS
LONG_TERM_LOG = "1"                 #Save log each iteration, On=1, Off=0
LOOP_AMOUNT = "inf"                   #Loop "x" times (inf = infinite)
EXCEL_SOURCE = "Test.xlsx"
EXCEL_RESULTS = "Test_RESULTS.xlsx"
#*******************************************************
...
sheet.cell(row=2,column=2).value = "GEN IP Address: " +IP           #IP Address
